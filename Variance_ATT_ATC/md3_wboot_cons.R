...
wb3.rad.c.cc <- sim.rad.h.cc
wb3.rad.c.cm <- sim.rad.h.cm
wb3.rad.c.mc <- sim.rad.h.mc
wb3.rad.c.mm <- sim.rad.h.mm

wb3.exp.c.cc <- sim.exp.h.cc
wb3.exp.c.cm <- sim.exp.h.cm
wb3.exp.c.mc <- sim.exp.h.mc
wb3.exp.c.mm <- sim.exp.h.mm

# Save data
save(file = "md3_sims_WBoot_cons.RData", 
     wb3.rad.c.cc, wb3.rad.c.cm, wb3.rad.c.mc, wb3.rad.c.mm, 
     wb3.exp.c.cc, wb3.exp.c.cm, wb3.exp.c.mc, wb3.exp.c.mm )
