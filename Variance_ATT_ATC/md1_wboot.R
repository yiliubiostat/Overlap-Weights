...
wb1.rad.h.cc <- sim.rad.h.cc
wb1.rad.h.cm <- sim.rad.h.cm
wb1.rad.h.mc <- sim.rad.h.mc
wb1.rad.h.mm <- sim.rad.h.mm

wb1.exp.h.cc <- sim.exp.h.cc
wb1.exp.h.cm <- sim.exp.h.cm
wb1.exp.h.mc <- sim.exp.h.mc
wb1.exp.h.mm <- sim.exp.h.mm

# Save data
save(file = "md1_sims_WBoot.RData", 
     wb1.rad.h.cc, wb1.rad.h.cm, wb1.rad.h.mc, wb1.rad.h.mm, 
     wb1.exp.h.cc, wb1.exp.h.cm, wb1.exp.h.mc, wb1.exp.h.mm )
