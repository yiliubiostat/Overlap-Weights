...
weight.data.reps <- weight.data.reps2
rm(sim2.aug.c.cc,sim2.aug.c.cm,sim2.aug.c.mc,sim2.aug.c.mm,
   sim2.aug.h.cc,sim2.aug.h.cm,sim2.aug.h.mc,sim2.aug.h.mm)
