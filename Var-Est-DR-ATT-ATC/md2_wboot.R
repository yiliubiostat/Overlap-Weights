...
# Summarize results
wb2.rad.h.cc <- sim.rad.h.cc
wb2.rad.h.cm <- sim.rad.h.cm
wb2.rad.h.mc <- sim.rad.h.mc
wb2.rad.h.mm <- sim.rad.h.mm

wb2.exp.h.cc <- sim.exp.h.cc
wb2.exp.h.cm <- sim.exp.h.cm
wb2.exp.h.mc <- sim.exp.h.mc
wb2.exp.h.mm <- sim.exp.h.mm

# Save data
save(file = "md2_sims_WBoot.RData", 
     wb2.rad.h.cc, wb2.rad.h.cm, wb2.rad.h.mc, wb2.rad.h.mm, 
     wb2.exp.h.cc, wb2.exp.h.cm, wb2.exp.h.mc, wb2.exp.h.mm )
