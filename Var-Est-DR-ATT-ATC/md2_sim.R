...
# Save data
save(file = "md2_sims_PSwt.RData", 
     weight.data.reps2, sim2.p, sim2.ratio, md2.true.h,
     sim2.aug.c.cc, sim2.aug.h.cc, sim2.aug.c.cm, sim2.aug.h.cm, 
     sim2.aug.c.mc, sim2.aug.h.mc, sim2.aug.c.mm, sim2.aug.h.mm )
