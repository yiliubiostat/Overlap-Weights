...
weight.data.reps <- weight.data.reps1
rm(sim1.aug.c.cc,sim1.aug.c.cm,sim1.aug.c.mc,sim1.aug.c.mm,
   sim1.aug.h.cc,sim1.aug.h.cm,sim1.aug.h.mc,sim1.aug.h.mm)
