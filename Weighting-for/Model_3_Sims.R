...
md3.alpha0 <- -0.78
weight.data.reps <- PS.model.reps(alpha0 = md3.alpha0, alpha1)
...
sim3.wt.c <- sim.wt.c %>% filter(Row.Num %in% R)
sim3.wt.h <- sim.wt.h %>% filter(Row.Num %in% R)
...
# Finally, save data!
save(file = "md3_sims.RData", weight.data.reps3, sim3.p, sim3.ratio, md3.true.h,
     sim3.wt.c, sim3.wt.h, sim3.aug.c.cc, sim3.aug.h.cc, 
     sim3.aug.c.cm, sim3.aug.h.cm, sim3.aug.c.mc, sim3.aug.h.mc, sim3.aug.c.mm, sim3.aug.h.mm )
